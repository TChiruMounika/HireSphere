  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12 transition-colors duration-300">
      ...
      <div className="bg-gradient-to-r from-slate-200 to-slate-300 dark:from-slate-800 dark:to-slate-900 p-8 rounded-2xl border border-slate-300 dark:border-slate-700 shadow-xl flex items-center gap-6 transition-colors duration-300">
        ...
        <div>
          <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white capitalize">{fullName || "User"}</h2>
          <p className="text-slate-600 dark:text-slate-400 mt-1">{activeUser.email} • <span className="uppercase text-xs font-bold text-purple-700 dark:text-purple-400 bg-purple-500/10 px-2 py-1 rounded">{activeUser.role}</span></p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden transition-colors duration-300">
        <div className="p-6 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/50 transition-colors duration-300">
          <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200">Profile Settings</h3>
          <p className="text-sm text-slate-500 dark:text-slate-500">Update your details and professional links for coordinators to view.</p>
        </div>
        ...
        <form onSubmit={handleSave} className="p-8">
          ...
          <div className="space-y-6">
            <h4 className="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-4 border-b border-slate-200 dark:border-slate-800 pb-2">Personal Details</h4>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">About Me (Bio)</label>
              <textarea
                value={bio}
          ...
          <div className="mt-10 space-y-6">
            <h4 className="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-4 border-b border-slate-200 dark:border-slate-800 pb-2">Professional Links</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg px-4 py-3 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 focus:outline-none focus:border-slate-500 focus:ring-1 focus:ring-slate-400 transition-colors"
                />
              </div>
            </div>
          </div>

          {/* SECTION 3: App Preferences (NEW THEME TOGGLE) */}
          <div className="mt-10 space-y-6">
            <h4 className="text-sm font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-4 border-b border-slate-200 dark:border-slate-800 pb-2">App Preferences</h4>
